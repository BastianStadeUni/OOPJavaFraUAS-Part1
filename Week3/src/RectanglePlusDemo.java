...
public class RectanglePlusDemo {
	...
	public static void main(String[] args) throws CloneNotSupportedException{
			...
			System.out.println("Cloned r4 onto r5");
			System.out.println("r5 with origin: (" + r5.origin.x + "|" + r5.origin.y + ") and height: " + r5.height + " and width: " + r5.width + " created, with copy of r4");
			System.out.println("Is r3 equal to r4? " + r3.equals(r4));
			System.out.println("Is r4 equal to r5? " + r4.equals(r5));
			System.out.println("Is r4 equal to r4? " + r4.equals(r4));
			System.out.println("Class of r4: " + r4.getClass());
